    ...
    <div class="dash-cont-inner">
        <div class="card-outer d-flex gap-48 align-flex-start flex-col">
            <div class="card-internal d-flex flex-col gap-16 align-flex-start w-100">
                ...
                <div class="d-grid col-2-1 gap-24 w-100 mb-8">
                    ...
                    <div class="right-box d-flex gap-24 flex-col">
                        <div class="risk-card bg-0B1417 br-12 border-E9E7DD-24 p-32-24">
                            ...
                            <div class="risk-card-content pt-24">
                                <div class="d-flex flex-col gap-15">
                                    <div class="d-flex justify-space-between gap-10 align-centers">
                                        <div class="left">
                        ...
                        <div class="risk-card bg-0B1417 br-12 border-E9E7DD-24 p-32-24">
                            ...
                            <div class="risk-card-content pt-24">
                                <div class="d-flex flex-col gap-15">
                                    <div class="d-flex justify-space-between gap-10 align-center">
                                        <div class="left">
                                            <p class="f-14 lh-16 clr-99ACB6 mb-8">
                        ...
                        <div class="risk-card bg-0B1417 br-12 border-E9E7DD-24 p-32-24">
                            <div class="risk-card-header d-flex align-center gap-10 justify-space-between">
                                <div>
                                    <div class="risk-title f-14 lh-14 clr-99ACB6 uppercase mb-8">FIXED INCOME</div>
                                    <div class="risk-value f-20 lh-22 white mb-16">$1,187,000</div>
                                    <p class="f-15 lh-15 clr-red-300 bold">
                                        9.52%
                                    </p>
                                </div>
                        ...
                        <div class="risk-card bg-0B1417 br-12 border-E9E7DD-24 p-32-24">
                            <div class="risk-card-header d-flex align-center gap-10 justify-space-between">
                                <div>
                                    <div class="risk-title f-14 lh-14 clr-99ACB6 uppercase mb-8">ALTS / PE</div>
                                    <div class="risk-value f-20 lh-22 white mb-16">$623,750</div>
                                    <p class="f-15 lh-15 clr-red-300 bold">
                                        5%
                                    </p>
                                </div>
                        ...
                        <div class="risk-card bg-0B1417 br-12 border-E9E7DD-24 p-32-24">
                            <div class="risk-card-header d-flex align-center gap-10 justify-space-between">
                                <div>
                                    <div class="risk-title f-14 lh-14 clr-99ACB6 uppercase mb-8">CASH</div>
                                    <div class="risk-value f-20 lh-22 white mb-16">$197,000</div>
                                    <p class="f-15 lh-15 clr-red-300 bold">
                                        1.58%
                                    </p>
                                </div>
                ...
                <div class="bg-108476-15  br-14 p-16-10 d-flex gap-10 align-center w-100">
                    <img src="{{ asset('images/information-line.svg') }}" alt="Information icon">
                    <p class="f-13 lh-18 neutral-300">
                        Important: High concentration in a single stock increases your portfolio's volatility and risk of permanent capital loss. We recommend reviewing your allocation with your advisor.
                    </p>
                </div>
            </div>
