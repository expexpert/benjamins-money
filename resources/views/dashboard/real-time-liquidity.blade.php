...
@section('title','Real Time Liquidity')
        ...
        <div class="dash-cont-outer">
            <div class="dash-cont-inner">
                <div class="d-flex flex-col gap-48">
                    <div class="d-grid col-lg-3 gap-10 p-32 bg-060F13 br-12 border-E9E7DD-15 ">
                        <div class="d-flex flex-col gap-16 ">
                            <div class="d-flex flex-col gap-6">
                                <h3 class="f-14 lh-14 clr-AEC2C7 uppercase">
                                    Unvested Inventory
                                </h3>
                                <h2 class="f-38 lh-40 white ls-042">
                                    $8,240,000
                                </h2>
                        ...
                        <div class="d-flex">
                            <img src="{{ asset('images/real-time-liquidity-graph.svg') }}" alt="real time liquidity graph">
                        </div>
                    </div>
